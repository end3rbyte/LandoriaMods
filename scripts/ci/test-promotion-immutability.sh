...
grep -Fq 'category="$(package_category "$package")"' "$promotion_script"
grep -Fq '.server_only_packages' "$promotion_script"
grep -Fq 'Released private server-only package' "$promotion_script"
