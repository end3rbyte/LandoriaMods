...
The server stores profiles as `characters_local/Steam_<id>_<character>.fch` and retains every
previous revision in a timestamped `characters_local/backups/` file.
