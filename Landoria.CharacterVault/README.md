...
- Writes profiles in the instance `characters_local` directory as
  `Steam_<id>_<character>.fch` through atomic replacement and retains every previous revision
  under `characters_local/backups/Steam_<id>_<character>_<UTC timestamp>.fch`.
